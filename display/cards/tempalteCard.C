{
  ...
  string dir="SUSYSSDL";
  string fileName="susy_SIGNAL_PTpt_LEPID_BTAG"; //was treeName in LUNE susy_cut_lowpt
  string fileList="susy_SIGNAL_PTpt_LEPID_BTAG"; //CH: since AnaConfig needs a fileName to open, we need to put the data files into a different variable
  string hName="";
  ...
  string autoBinFile="susybinningPT";
...
//  md.anConf.addSample( "DYJetsM50_HT600toInf_PU_S14_POSTLS170_skim",             "Z+jets",    kAzure+6 );
  ...
  md.anConf.addSample( "T1tttt_2J_mGo800_mStop300_mCh285_mChi280_pythia8_S14_skim", "T1tttt(8/3/#chi)*20 sig", kRed+1 );
  md.anConf.addSample( "T1tttt_2J_mGo1300_mStop300_mChi280_pythia8_S14_skim", "T1tttt(13/3)*5 sig", kRed+1 );
  md.anConf.addSample( "T1tttt_2J_mGo1300_mStop300_mCh285_mChi280_pythia8_S14_skim", "T1tttt(13/3/#chi)*20 sig", kRed+1 );
  md.anConf.addSample( "T1tttt_2J_mGo800_mStop300_mChi280_pythia8_S14_skim", "T1tttt(8/3)*5 sig", kRed+1 );
  ...
  md.anConf.addSample( "T5Full_1500_800_100_skim"                            ,  "T5WW(HL)*20 sig"  , kOrange+6  );
  ...
  //  md.producePlots("susy_SIGNAL_PTpt_LEPID_BTAG");
  md.getStatistics();
