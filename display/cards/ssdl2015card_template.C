...
void dataCardProd_CATTAG_SIGTAG() {
  ...
  //lumi
  md.addNuisanceParameter("lumi","WZ:ttW:ttHZ:WW:XG:rares:SIGTAG","lnN","1.08:1.08:1.08:1.08:1.08:1.08:1.08");
  ...
  md.addNuisanceParameter("JES","ttW:ttHZ:WW:XG:rares:SIGTAG","lnN","");
  md.addNuisanceParameter("BTag","ttW:ttHZ:WW:XG:rares:SIGTAG","lnN","");
