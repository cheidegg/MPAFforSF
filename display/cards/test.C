{
  ...
  string dir="SUSYSSDL";
  string fileName="susy__TTWJets_S14_"; //was treeName in LUNE
  string hName="";
...
//  md.anConf.addSample( "DYJetsM50_HT600toInf_PU_S14_POSTLS170_skim",             "Z+jets",    kAzure+6 );
  ...
  md.anConf.addSample( "TTHnlo_S14_skim",             "TTH",    kOrange-2 );
  md.anConf.addSample( "TTWJets_S14_skim",             "TTW",    kOrange-2 );
  md.anConf.addSample( "TTZJets_S14_skim",             "TTZ",    kOrange-2 );
